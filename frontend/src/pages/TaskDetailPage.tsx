...
import { TaskForm, TaskReadView } from '@/components/tasks';
...
export function TaskDetailPage() {
  ...
  const task = listData?.data.find((x) => x.id === id) ?? null;
        ...
        <div className="max-w-[1400px] mx-auto px-8 py-2.5 flex items-center gap-2">
          ...
          {!editMode && (
            <div className="ml-auto flex items-center gap-2">
              <button
                onClick={() => navigate(`/tasks/new?parentId=${task.id}`)}
