...
import {
  ...
  ChevronDown, ChevronRight, Zap, Route, Share2, Rss, Users, GitCommit, Terminal,
} from 'lucide-react';
...
const NAV_GROUPS: Array<{ id: string; label: string; paths: string[] }> = [
  ...
  { id: 'cluster',    label: '클러스터', paths: ['/cluster-manage', '/versions', '/bulk-exec', '/infra-topology', '/links', '/node-labels', '/cidr'] },
